    ...
    return(
        <div className = 'shop'>
            <Saleitem  img = {image1} name = 'Nike Airforce 1 White' 
              ...
              price= '$500' children = {props.children} setchildren = {props.setchildren} total = {props.total} 
              settotal = {props.settotal} />

            <Saleitem  img = {image2} name='Nike Dunk Low Black White Panda' 
             iscartopen={props.iscartopen} setiscartopen={props.setiscartopen} itemimg={image1} qtty={props.qtty} 
             setqtty={props.setqtty} cartcounter = {props.cartcounter} setcartcounter = {props.setcartcounter}  
             children = {props.children} setchildren = {props.setchildren} price= '$300' total = {props.total} 
             settotal = {props.settotal} />

            <Saleitem  img = {image3} name='Nike Airforce 1 Supreme White' 
             iscartopen={props.iscartopen} setiscartopen={props.setiscartopen} itemimg={image1} qtty={props.qtty} 
             setqtty={props.setqtty} cartcounter = {props.cartcounter} setcartcounter = {props.setcartcounter} 
             children = {props.children} setchildren = {props.setchildren} price= '$250' total = {props.total}
             settotal = {props.settotal} />

            <Saleitem  img = {image5} name='Air Jordan 1 Mid White Black Royal' 
            iscartopen={props.iscartopen} setiscartopen={props.setiscartopen} itemimg={image1} qtty={props.qtty} 
            setqtty={props.setqtty} cartcounter = {props.cartcounter} setcartcounter = {props.setcartcounter}  
            children = {props.children} setchildren = {props.setchildren} price= '$109' total = {props.total}
            settotal = {props.settotal} />

            <Saleitem  img = {image6} name='Nike Airforce 1 UV Reactive swoosh' 
            iscartopen={props.iscartopen} setiscartopen={props.setiscartopen} itemimg={image1} qtty={props.qtty} 
            setqtty={props.setqtty} cartcounter = {props.cartcounter} setcartcounter = {props.setcartcounter} 
            children = {props.children} setchildren = {props.setchildren} price= '$350' total = {props.total} 
            settotal = {props.settotal}/>    
            
            <Saleitem  img = {image7} name='Nike Airforce 1 Supreme Black'  
            iscartopen={props.iscartopen} setiscartopen={props.setiscartopen} itemimg={image1} qtty={props.qtty}
            setqtty={props.setqtty} cartcounter = {props.cartcounter} setcartcounter = {props.setcartcounter}
            children = {props.children} setchildren = {props.setchildren} price= '$170' total = {props.total} 
            settotal = {props.settotal}/>
...
function Saleitem(props){
    ...
    return(
        <div className= 'saleitem'>
            ...
            itemname = {props.name} qtty={props.qtty} setqtty={props.setqtty} cartcounter = {props.cartcounter} 
            setcartcounter = {props.setcartcounter} children = {props.children} setchildren = {props.setchildren}
            price = {props.price} total = {props.total} settotal = {props.settotal}/>
        </div>
    )
}
